...
contract MarketCreationTest is BaseTest {
    ...
    function test_CreateMarket_Success() public {
        ...
        assertEq(uint8(m.state), uint8(HashPrediction.MarketState.Active));
        assertEq(uint8(m.winningOutcome), uint8(HashPrediction.Outcome.None));
    ...
    function test_CreateMarket_ConfigSnapshot() public {
        ...
        HashPrediction.Market memory m2 = market.getMarket(marketId2);

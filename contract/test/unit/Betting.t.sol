...
contract BettingTest is BaseTest {
    ...
    function test_PlaceBet_MultipleUsers() public {
        ...
        placeBet(charlie, marketId, HashPrediction.Outcome.No, usdc(75));
    ...
    function test_PlaceBet_RevertIf_ZeroAmount() public {
        vm.prank(alice);
        vm.expectRevert(HashPrediction.ZeroAmount.selector);
        market.placeBet(marketId, HashPrediction.Outcome.Yes, 0);
    }
    ...
    function test_PlaceBet_RevertIf_InvalidOutcome() public {
        ...
        market.placeBet(marketId, HashPrediction.Outcome.None, usdc(100));
    }
    ...
    function test_PlaceBet_RevertIf_InvalidMarket() public {
        ...
        market.placeBet(999, HashPrediction.Outcome.Yes, usdc(100));
    }
    ...
    function test_PlaceBet_RevertIf_MarketResolved() public {
        ...
        market.placeBet(marketId, HashPrediction.Outcome.Yes, usdc(100));
    }
    ...
    function test_PlaceBet_RevertIf_MarketExpired() public {
        ...
        vm.prank(alice);
        vm.expectRevert(HashPrediction.MarketExpired.selector);
        market.placeBet(marketId, HashPrediction.Outcome.Yes, usdc(100));
    }

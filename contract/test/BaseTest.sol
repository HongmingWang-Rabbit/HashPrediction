...
abstract contract BaseTest is Test {
    // ============ Events (copied from HashPrediction for testing) ============
    event MarketCreated(
    ...
    event BetPlaced(
        ...
        HashPrediction.Outcome outcome,
        uint256 amount,
        uint256 timestamp
    );
    ...
    function resolveMarket(uint256 marketId, HashPrediction.Outcome outcome) internal {
        vm.prank(admin);
